Public Module NumberToWordConverter
    Function strReplicate(ByVal str As String, ByVal intD As Integer) As String
        ...
        Return strReplicate
    End Function
    Function AmtInWord(ByVal Num As Decimal, Optional ByVal currencyCode As String = Nothing, Optional ByVal currencyDesc As String = Nothing) As String
        ...
        If currencyCode = "INR" Then
            ...
            End If
        Else
            StrWord = currencyDesc + " " + NumToWord(CDbl(strNum))
        End If
