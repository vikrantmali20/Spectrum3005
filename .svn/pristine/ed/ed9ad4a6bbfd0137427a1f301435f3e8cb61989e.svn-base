...
#Region "Global Varibale for class"
    ...
    Dim lblOnlineOrder As New CtrlLabel
...
#Region "Class Events"
    ...
    Private Sub frmCashMemo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler lblOnlineOrder.Click, AddressOf OnlineOrderScreen
    End Sub

    Public Sub OnlineOrderScreen()
        Try
            Dim objOnlineOrder As New frmonlineOrders(False)
            objOnlineOrder.ShowDialog()
        Catch ex As Exception
            LogException(ex)
        End Try
        ...
        Try
            ...
            If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                If Not objSearch.search Is Nothing AndAlso objSearch.search.Length > 0 Then
                    ...
                    obj.AllowDecimalQty = clsDefaultConfiguration.AllowDecimalQty
                    obj.WeightScaleEnabled = clsDefaultConfiguration.WeightScaleEnabled
                    obj.DisplayBrandWiseSale = clsDefaultConfiguration.DisplayBrandWiseSale
...
NextLineForBackButton: pnlBackBtn.Size = New Size(ctrlBack.Width, ctrlBack.Size.Height + 10)
        ...
        lblOnlineOrder.FlatStyle = FlatStyle.Flat
        lblOnlineOrder.Text = "Online Order"
        lblOnlineOrder.Image = Nothing
        lblOnlineOrder.Font = New Font("Neo Sans", 9, FontStyle.Bold)
        lblOnlineOrder.VisualStyleBaseStyle = C1.Win.C1Input.VisualStyle.System
        lblOnlineOrder.TextAlign = ContentAlignment.MiddleCenter
        lblOnlineOrder.BackColor = Color.FromArgb(228, 37, 44)
        lblOnlineOrder.ForeColor = Color.White
        lblOnlineOrder.Dock = DockStyle.Left
        TableLayoutPanel2.Controls.Add(lblOnlineOrder, 9, 0)
