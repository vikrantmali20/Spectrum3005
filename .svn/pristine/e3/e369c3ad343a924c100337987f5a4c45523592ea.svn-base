...
#Region "Property for  Printing format for A4 size "
    ...
    ''' <UsedBy>clsBirthList.cs,clsPrintSalesOrder.cs</UsedBy>
    ''' <remarks>String</remarks>
    Private _strA4SiteHeader As String
    Public Property A4SiteHeader() As String
        Get
            Return _strA4SiteHeader
        End Get
        Set(ByVal value As String)
            _strA4SiteHeader = value
        End Set
    End Property
    ''' <summary>
...
#End Region
    ...
    Public Function fnPrint(Optional ByVal strPrintOrPreview As String = "") As String
        ...
        If Not A4SiteHeader Is Nothing AndAlso Not String.IsNullOrEmpty(A4SiteHeader.Trim()) Then
            arryList.Add(A4SiteHeader, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + vbCrLf, SpectrumPrintFontNew.Title)
        End If
        If Not A4Header Is Nothing AndAlso Not String.IsNullOrEmpty(A4Header.Trim()) Then
            arryList.Add(A4Header, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(1), SpectrumPrintFontNew.Title)
        End If
        If Not A4WelcomeMessage Is Nothing AndAlso Not String.IsNullOrEmpty(A4WelcomeMessage.Trim()) Then
            arryList.Add(A4WelcomeMessage, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(2), SpectrumPrintFontNew.Title)
        End If

        arryList.Add(A4Title, SpectrumPrintFontNew.CashierDetails)
        arryList.Add(strLineA4 + Space(3), SpectrumPrintFontNew.Title)

        arryList.Add(A4CashierDetails & vbCrLf, SpectrumPrintFontNew.CashierDetails)

        If Not A4TaxInformation Is Nothing AndAlso Not String.IsNullOrEmpty(A4TaxInformation.Trim()) Then
            arryList.Add(strLineA4 + Space(4), SpectrumPrintFontNew.Title)
            arryList.Add(A4TaxInformation, SpectrumPrintFontNew.Title)
        End If

        arryList.Add(strLineA4 + Space(5), SpectrumPrintFontNew.Title)
        'arryList.Add(A4CashierDetails + vbCrLf + "LineBreak", SpectrumPrintFontNew.CustomerInfo)

        arryList.Add(A4CustomerDetails, SpectrumPrintFontNew.CustomerInfo)
        If Not A4DeliveryAddress Is Nothing AndAlso Not String.IsNullOrEmpty(A4DeliveryAddress.Trim()) Then
            arryList.Add(A4DeliveryAddress, SpectrumPrintFontNew.DeliveryAddress)
        End If

        arryList.Add(A4Remark + vbCrLf, SpectrumPrintFontNew.Remark)
        arryList.Add(strLineA4 + Space(6), SpectrumPrintFontNew.Title)
        arryList.Add(A4ItemHeader, SpectrumPrintFontNew.ItemHeader)
        arryList.Add(A4ItemDetails, SpectrumPrintFontNew.ItemDetail)
        arryList.Add(strLineA4 + Space(7), SpectrumPrintFontNew.Title)
        If DocumentType = DocumentTypeList.BirthListStatus Then
            'arryList.Add(String.Format("{0} ", "GIFT VOUCHERS ".PadRight(90) + vbCrLf + "LineBreak"), SpectrumPrintFontNew.ItemHeader)
            arryList.Add(String.Format("{0} ", (getValueByKey("CLSA4P001") & " ").PadRight(90)), SpectrumPrintFontNew.ItemHeader)
            If Not A4GiftVoucher Is Nothing AndAlso Not String.IsNullOrEmpty(A4GiftVoucher) Then
                arryList.Add(A4GiftVoucher + vbCrLf, SpectrumPrintFontNew.Title)
            End If
            arryList.Add(strLineA4 + Space(8), SpectrumPrintFontNew.Title)

            'arryList.Add(String.Format("{0} ", "OPEN AMOUNT ".PadRight(90)), SpectrumPrintFontNew.ItemHeader)
            arryList.Add(String.Format("{0} ", (getValueByKey("CLSA4P002") & " ").PadRight(90)), SpectrumPrintFontNew.ItemHeader)
            If Not A4OpenAmount Is Nothing Then
                'arryList.Add(String.Format("{0} {1} ", "Open amount ".PadRight(90), A4OpenAmount + vbCrLf + "LineBreak"), SpectrumPrintFontNew.ItemDetail)
                arryList.Add(String.Format("{0} {1} ", (getValueByKey("CLSA4P003") & " ").PadRight(90), A4OpenAmount), SpectrumPrintFontNew.ItemDetail)
            End If
            arryList.Add(strLineA4 + Space(9), SpectrumPrintFontNew.Title)
            ...
            arryList.Add(strFinalDiscount, SpectrumPrintFontNew.ItemDetail)
        End If

        If Not A4PaymentDetails Is Nothing AndAlso Not String.IsNullOrEmpty(A4PaymentDetails.Trim()) Then

            arryList.Add(A4PaymentDetails + vbCrLf, SpectrumPrintFontNew.ItemDetail)
            arryList.Add(strLineA4 + Space(10), SpectrumPrintFontNew.Title)
        End If

        If DocumentType = DocumentTypeList.SalesOrder AndAlso Not A4TaxDetailsInvoice Is Nothing Then
            If Not String.IsNullOrEmpty(A4TaxDetailsInvoice.Trim()) Then
                'arryList.Add(String.Format("{0} ", "Tax Details ".PadRight(90) + vbCrLf + "LineBreak"), SpectrumPrintFontNew.ItemHeader)
                arryList.Add(String.Format("{0} ", (getValueByKey("CLSA4P005") & " ").PadRight(90)), SpectrumPrintFontNew.ItemDetail)

                arryList.Add(A4TaxDetailsInvoice, SpectrumPrintFontNew.ItemDetail)
                arryList.Add(strLineA4 + Space(11), SpectrumPrintFontNew.Title)
            End If
        End If
        If Not A4TermsNConditions Is Nothing AndAlso Not String.IsNullOrEmpty(A4TermsNConditions.Trim()) Then
            arryList.Add(A4TermsNConditions, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(12), SpectrumPrintFontNew.Title)
        End If
        If Not A4PromotionInformation Is Nothing AndAlso Not String.IsNullOrEmpty(A4PromotionInformation.Trim()) Then
            arryList.Add(A4PromotionInformation, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(14), SpectrumPrintFontNew.Title)
        End If
        If Not GiftReceiptMessage Is Nothing AndAlso Not String.IsNullOrEmpty(GiftReceiptMessage.Trim()) Then
            arryList.Add(GiftReceiptMessage, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(15), SpectrumPrintFontNew.Title)
        End If
        If Not A4Footer Is Nothing AndAlso Not String.IsNullOrEmpty(A4Footer.Trim()) Then
            arryList.Add(A4Footer, SpectrumPrintFontNew.Title)
            arryList.Add(strLineA4 + Space(13), SpectrumPrintFontNew.Title)
        End If
                            ...
                            If Not (LinePrint(e, strLine, strLinFont)) Then
                                ...
                                If currentIndex < strLine.Length Then
                                    ...
                                    For j As Integer = 0 To strLine.Length - 1
                                        ...
                                        End If
                                    Next j
                                    arryList.Add(strb.ToString(), SpectrumPrintFontNew.ItemDetail)
    ...
    'Rohit Start
    Public Sub OperateDevice(ByVal strDeviceType As String, Optional ByVal strToPrint As String = Nothing)
...
''' </summary>
''' <remarks></remarks>
Public Class SpectrumPrintFontNew
    ''' <summary>
    '''  Header Font
    ''' </summary>
    ...
    Public Shared ReadOnly Property Header() As Font
        Get
            Dim MyFont As New System.Drawing.Font("Courier New", 8.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Return MyFont
        End Get
    End Property
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared ReadOnly Property SiteHeader() As Font
        Get
            Dim MyFont As New System.Drawing.Font("Courier New", 8.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Return MyFont
        End Get
    ...
    Public Shared ReadOnly Property Title() As Font
        Get
            Dim MyFont As New System.Drawing.Font("Courier New", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Return MyFont
        End Get
    End Property
    ...
    Public Shared ReadOnly Property ItemHeader() As Font
        Get
            Dim MyFont As New System.Drawing.Font("Courier New", 7.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Return MyFont
        End Get
    End Property
    ...
    Public Shared ReadOnly Property ItemDetail() As Font
        Get
            Dim MyFont As New System.Drawing.Font("Courier New", 7.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            Return MyFont
        End Get
    End Property
    ''' <summary>
