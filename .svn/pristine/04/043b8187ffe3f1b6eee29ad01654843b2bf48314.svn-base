    ...
    Private Sub btnSearch_Click(sender As System.Object, e As System.EventArgs) Handles btnSearch.Click
        Try
            ...
            If cmbType.Text.Replace(Space(1), String.Empty) = CreditSaleSearchType.CashMemo.ToString() Then
                ...
                Dim popup As New frmPropmtHD(CashmemoList, "InvoiceNumber", getValueByKey("Crs012"), displayGridColumns)
                popup.ShowDialog()
            ...
            ElseIf cmbType.Text.Replace(Space(1), String.Empty) = CreditSaleSearchType.SalesOrder.ToString() Then
                ...
                Dim popup As New frmPropmtHD(SalesorderList, "InvoiceNumber", getValueByKey("Crs013"), displayGridColumns)
                popup.ShowDialog()
            ...
            ElseIf cmbType.Text.Replace(Space(1), String.Empty) = CreditSaleSearchType.Customer.ToString() Then
                ...
                Dim popup As New frmPropmtHD(CustomerList, "CardNumber", getValueByKey("Crs014"), displayCustomerColumns)
                popup.ShowDialog()
                If Not popup.SelectedVal = "" Then
                    Dim SalesByCustomer = CreditSale.getBillbyCustomer(popup.SelectedVal)

                    popup = New frmPropmtHD(SalesByCustomer, "InvoiceNumber", getValueByKey("Crs013"), displayGridColumns)
                    popup.ShowDialog()
                    If Not popup.SelectedVal = "" Then
            ...
            ElseIf cmbType.Text.Replace(Space(1), String.Empty) = CreditSaleSearchType.SalesPerson.ToString() Then
                ...
                Dim popup As New frmPropmtHD(SalesorderList, "InvoiceNumber", getValueByKey("Crs023"), displayGridColumns)
                popup.ShowDialog()
