...
Public Class CtrlMODMenu
    ...
    Private _parent As frmFastCashMemo
    Public Property Parent As frmFastCashMemo
        Get
            Return _parent
        End Get
        Set(ByVal value As frmFastCashMemo)
            _parent = value
        End Set
    End Property
    ...
    Public Sub CreateButtonsInTabPanel()
        ...
        If clsDefaultConfiguration.ThemeSelect = "Theme 1" Then
            ...
            tabControlMain.MaximumSize = New Size((My.Computer.Screen.WorkingArea.Width * 750) / 1366, 544)
