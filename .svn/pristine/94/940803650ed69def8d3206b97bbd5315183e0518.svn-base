...
namespace Spectrum.DAL
{
    ...
    public static class EntityDataExtensions
    {
        ...
        {
            private static readonly MethodInfo s_fieldOrdinalMethod = typeof(EntityDataExtensions).GetMethod("Field", new Type[] { typeof(IDataRecord), typeof(int) });
            private static readonly MethodInfo s_fieldNameMethod = typeof(EntityDataExtensions).GetMethod("Field", new Type[] { typeof(IDataRecord), typeof(string) });
