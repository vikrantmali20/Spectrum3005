...
Public Class DayCloseController
    ...
    Public Sub New()
        Try
            If clsDefaultConfiguration.DayCloseOtherScreens Then
                DayCloseScreenList = _objClsDayClose.GetDayCloseScreenConfig(Modules.Day_Close, DayCloseScreens.None)
            Else
                DayCloseScreenList = _objClsDayClose.GetDayCloseScreenConfig(Modules.Day_Close, DayCloseScreens.BankDetails)
            End If      
