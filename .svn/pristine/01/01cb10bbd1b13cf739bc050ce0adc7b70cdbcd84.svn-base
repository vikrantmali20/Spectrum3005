...
namespace Spectrum.DAL
{
    ...
    public sealed class Materializer<T>
    {
        ...
        private static readonly MethodInfo s_fieldOfTOrdinalMethod = typeof(EntityDataExtensions).GetMethod("Field", new Type[] { typeof(IDataRecord), typeof(int) });
        private static readonly MethodInfo s_fieldOfTColumnNameMethod = typeof(EntityDataExtensions).GetMethod("Field", new Type[] { typeof(IDataRecord), typeof(string) });
