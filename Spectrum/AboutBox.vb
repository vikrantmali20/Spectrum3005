...
#End Region
    ...
    Private Function AssemblyAttribs(ByVal a As System.Reflection.Assembly) As Specialized.NameValueCollection
            ...
            Try
                Select Case TypeName
                    Case "System.CLSCompliantAttribute"
                        Value = IIf(CType(attrib, CLSCompliantAttribute).IsCompliant = Nothing, String.Empty, CType(attrib, CLSCompliantAttribute).IsCompliant.ToString)
                    Case "System.Diagnostics.DebuggableAttribute"
                        Value = IIf(CType(attrib, Diagnostics.DebuggableAttribute).IsJITTrackingEnabled = Nothing, String.Empty, CType(attrib, Diagnostics.DebuggableAttribute).IsJITTrackingEnabled.ToString)
                    Case "System.Reflection.AssemblyCompanyAttribute"
                        Value = IIf(CType(attrib, AssemblyCompanyAttribute).Company = Nothing, String.Empty, CType(attrib, AssemblyCompanyAttribute).Company.ToString)
                    Case "System.Reflection.AssemblyConfigurationAttribute"
                        Value = IIf(CType(attrib, AssemblyConfigurationAttribute).Configuration <> Nothing, CType(attrib, AssemblyConfigurationAttribute).Configuration.ToString, String.Empty)
                    Case "System.Reflection.AssemblyCopyrightAttribute"
                        Value = IIf(CType(attrib, AssemblyCopyrightAttribute).Copyright <> Nothing, CType(attrib, AssemblyCopyrightAttribute).Copyright.ToString, String.Empty)
                    Case "System.Reflection.AssemblyDefaultAliasAttribute"
                        Value = IIf(CType(attrib, AssemblyDefaultAliasAttribute).DefaultAlias <> Nothing, CType(attrib, AssemblyDefaultAliasAttribute).DefaultAlias.ToString, String.Empty)
                    Case "System.Reflection.AssemblyDelaySignAttribute"
                        Value = IIf(CType(attrib, AssemblyDelaySignAttribute).DelaySign <> Nothing, CType(attrib, AssemblyDelaySignAttribute).DelaySign.ToString, String.Empty)
                    Case "System.Reflection.AssemblyDescriptionAttribute"
                        Value = IIf(CType(attrib, AssemblyDescriptionAttribute).Description <> Nothing, CType(attrib, AssemblyDescriptionAttribute).Description.ToString, String.Empty)
                    Case "System.Reflection.AssemblyInformationalVersionAttribute"
                        Value = IIf(CType(attrib, AssemblyInformationalVersionAttribute).InformationalVersion <> Nothing, CType(attrib, AssemblyInformationalVersionAttribute).InformationalVersion.ToString, String.Empty)
                    Case "System.Reflection.AssemblyKeyFileAttribute"
                        Value = IIf(CType(attrib, AssemblyKeyFileAttribute).KeyFile <> Nothing, CType(attrib, AssemblyKeyFileAttribute).KeyFile.ToString, String.Empty)
                    Case "System.Reflection.AssemblyProductAttribute"
                        Value = IIf(CType(attrib, AssemblyProductAttribute).Product <> Nothing, CType(attrib, AssemblyProductAttribute).Product.ToString, String.Empty)
                    Case "System.Reflection.AssemblyTrademarkAttribute"
                        Value = IIf(CType(attrib, AssemblyTrademarkAttribute).Trademark <> Nothing, CType(attrib, AssemblyTrademarkAttribute).Trademark.ToString, String.Empty)
                    Case "System.Reflection.AssemblyTitleAttribute"
                        Value = IIf(CType(attrib, AssemblyTitleAttribute).Title <> Nothing, CType(attrib, AssemblyTitleAttribute).Title.ToString, String.Empty)
                    Case "System.Resources.NeutralResourcesLanguageAttribute"
                        Value = IIf(CType(attrib, Resources.NeutralResourcesLanguageAttribute).CultureName <> Nothing, CType(attrib, Resources.NeutralResourcesLanguageAttribute).CultureName.ToString, String.Empty)
                    Case "System.Resources.SatelliteContractVersionAttribute"
                        Value = IIf(CType(attrib, Resources.SatelliteContractVersionAttribute).Version <> Nothing, CType(attrib, Resources.SatelliteContractVersionAttribute).Version.ToString, String.Empty)
                    ...
                    Case "System.Runtime.InteropServices.ComVisibleAttribute"
                        Value = IIf(CType(attrib, Runtime.InteropServices.ComVisibleAttribute).Value <> Nothing, CType(attrib, Runtime.InteropServices.ComVisibleAttribute).Value.ToString, String.Empty)
                    Case "System.Runtime.InteropServices.GuidAttribute"
                        Value = IIf(CType(attrib, Runtime.InteropServices.GuidAttribute).Value <> Nothing, CType(attrib, Runtime.InteropServices.GuidAttribute).Value.ToString, String.Empty)
        ...
        With nvc
            ...
            Else
                .Add("BuildDate", dt.ToString(GetSystemDateFormat() & " hh:mm tt"))
            End If
            '-- location
            Try
    ...
    Private Sub ShowSysInfo()
        ...
        If strSysInfoPath = "" Then
            MessageBox.Show(getValueByKey("ABT002") & _
                Environment.NewLine & _
                Environment.NewLine & _
                "(" & getValueByKey("ABT001") & ")", _
        ...
        Catch ex As Exception
            MessageBox.Show(getValueByKey("ABT002") & _
                Environment.NewLine & _
                Environment.NewLine & _
                "(" & getValueByKey("ABT003") & " '" & strSysInfoPath & "')", _
    ...
    Private Function Themechange()
        ...
        Me.AppTitleLabel.ForeColor = Color.White
        Me.AppDescriptionLabel.ForeColor = Color.White
        Me.AppVersionLabel.ForeColor = Color.White
        Me.AppDateLabel.ForeColor = Color.White
        Me.AppCopyrightLabel.ForeColor = Color.White

        Me.DetailsButton.VisualStyle = C1.Win.C1Input.VisualStyle.System
        Me.SysInfoButton.VisualStyle = C1.Win.C1Input.VisualStyle.System
        Me.OKButton.VisualStyle = C1.Win.C1Input.VisualStyle.System

        Me.OKButton.Location = New Point(310, 131)
        Me.OKButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.OKButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.OKButton.ForeColor = Color.White
        Me.OKButton.FlatStyle = FlatStyle.Flat
        Me.OKButton.Font = New Font("Tahoma", 8, FontStyle.Bold)
        Me.OKButton.Height = 26
        Me.OKButton.FlatAppearance.BorderColor = Color.FromArgb(0, 107, 163)
        Me.OKButton.FlatAppearance.BorderSize = 0

        Me.DetailsButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.DetailsButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.DetailsButton.ForeColor = Color.White
        Me.DetailsButton.FlatStyle = FlatStyle.Flat
        Me.DetailsButton.Font = New Font("Tahoma", 8, FontStyle.Bold)
        Me.DetailsButton.Height = 26
        Me.DetailsButton.FlatAppearance.BorderColor = Color.FromArgb(0, 107, 163)
        Me.DetailsButton.FlatAppearance.BorderSize = 0

        Me.SysInfoButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.SysInfoButton.BackColor = Color.FromArgb(0, 107, 163)
        Me.SysInfoButton.ForeColor = Color.White
        Me.SysInfoButton.FlatStyle = FlatStyle.Flat
        Me.SysInfoButton.Font = New Font("Tahoma", 8, FontStyle.Bold)
        Me.SysInfoButton.Height = 26
        Me.SysInfoButton.Width = 95
        Me.SysInfoButton.FlatAppearance.BorderColor = Color.FromArgb(0, 107, 163)
        Me.SysInfoButton.FlatAppearance.BorderSize = 0
    End Function
