...
Public Class frmNAcceptPayment
...
#Region "Page Variables"
    ...
    Dim isClearGridNeeded As Boolean = False
...
#Region "Property"
    ...
    Public Property TotalBillAmount() As Double
        ...
        End Get
        Set(ByVal value As Double)
            'Code is added by irfan for Mantis issues===============================
            If clsDefaultConfiguration.RoundOffRequired Then
                _totalAmount = MyRound(value, clsDefaultConfiguration.BillRoundOffAt)
            Else
                _totalAmount = MyRound(value, 2)
            End If
            '=======================================================================
            ' _totalAmount = MyRound(value, clsDefaultConfiguration.BillRoundOffAt)
...
#Region "Methods"
    ...
    Private Sub frmAcceptPayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If (dgGridReciept.DataSource Is Nothing) Then
                dgGridReciept.Cols(0).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.tendertype")
                dgGridReciept.Cols(1).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.asabove_0")
                dgGridReciept.Cols(3).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.asabove_1")
                dgGridReciept.Cols(4).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.date")
                dgGridReciept.Cols(5).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.passkeyvalue")
                dgGridReciept.Cols(6).Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.passkeynumber")
            Else
                Grid_DisplaySetting()
            End If
            ...
            If PaymentType = clsAcceptPayment.PaymentType.EditBill Then
                If dgGridReciept.Rows.Count = 2 Then
                    isClearGridNeeded = True
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub SetTabSequence()
        Try
            ...
            ctrTablIndex.Add(Me.remarksTextbox, 0)
    ...
    Private Function Themechange() As String
        ...
        If btnGift.Visible = True Then
            '  btnCancel.Location = New System.Drawing.Point(890, 5)
    ...
    Public Sub InsertReceiptCashDetails()
        Try
            ...
            ElseIf (SelectedReceiptTypeCode = AcceptPaymentTenderType.PositiveTenderType.Cash Or SelectedReceiptTypeCode = AcceptPaymentTenderType.PositiveTenderType.Credit _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.Neft.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.Rtgs.ToUpper() Or _
                    ...
                    SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.QuickWallet.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.JioMoney.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.Sodexo.ToUpper() Or _
                    SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.Tr.ToUpper() Or _
                    SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.SwiggyOnline.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.ZomatoOnline.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.TicketRestaurant.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.OnlinePayment.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.ZomatoCash.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.SwiggyCash.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.ScootsyOnline.ToUpper() _
                    Or SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.ScootsyCash.ToUpper() Or _
                    ...
                    SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.FoodPandaCash.ToUpper() Or _
                    SelectedReceiptTypeCode.ToUpper() = AcceptPaymentTenderType.PositiveTenderType.FoodPandaOnline.ToUpper()) Then 'Or SelectedReceiptTypeCode = AcceptPaymentTenderType.NegativeTenderType.Cash) Then 'Or SelectedReceiptTypeCode = AcceptPaymentTenderType.PositiveTenderType.ParkingCoupen) Then
    ...
    Private Sub Grid_DisplaySetting()
        Try
            ...
            dgGridReciept.Cols("Reciept").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.tendertype")   'col index 1
            dgGridReciept.AutoSizeCol(1, 10)

            dgGridReciept.Cols("Amount").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.asabove_0")     'col index 3
            dgGridReciept.AutoSizeCol(3, 10)

            dgGridReciept.Cols("Number").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.asabove_1")     'col index 5
            dgGridReciept.Cols("Number").Width = 145

            dgGridReciept.Cols("Date").Visible = True                                                                           'col index 6
            dgGridReciept.Cols("Date").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.date")
            dgGridReciept.AutoSizeCol(6, 10)

            dgGridReciept.Cols("RefNO_3").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.passkeyvalue")    'col index 10
            dgGridReciept.Cols("RefNO_3").Width = 170
            dgGridReciept.AutoSizeCol(10, 10)

            dgGridReciept.Cols("RefNO_4").Caption = modCommonFunc.getValueByKey("frmnacceptpayment.dggridreciept.passkeynumber")     'col index 11
            ...
            dgGridReciept.Cols("RecieptType").Visible = False       'col index 2
    ...
    Protected Sub AddRowRecipetAmountInGrid(ByVal strRecieptType As String, ByVal strAmount As String, ByVal strNumber As String, ByVal dtDate As Object, ByVal bankName As String)
        If Not (IsRecieptAmountClose) Then
...
#Region "Events"
    ...
    Private Sub cboRecieptType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboRecieptType.SelectedValueChanged
        'code added by vipul for whenever their is one row in edit bill grid if user change the tender grid should be clear
        If isClearGridNeeded Then
            If dgGridReciept.Rows.Count = 2 Then
                dgGridReciept.Rows.Remove(1)
                dtRecieptType.AcceptChanges()
                isClearGridNeeded = False
                IsRecieptAmountClose = False
                '  ctrlPayCash.txtCash.Enabled = True
                'ctrlPayCash.txtCash.Text = TotalBillAmount
        ...
        Select Case (SelectedReceiptTypeCode)
            'Case AcceptPaymentTenderType.PositiveTenderType.Cash, AcceptPaymentTenderType.PositiveTenderType.Neft, AcceptPaymentTenderType.PositiveTenderType.Rtgs, AcceptPaymentTenderType.PositiveTenderType.MealPass, AcceptPaymentTenderType.PositiveTenderType.Paytm, AcceptPaymentTenderType.PositiveTenderType.QuickWallet, AcceptPaymentTenderType.PositiveTenderType.JioMoney, AcceptPaymentTenderType.PositiveTenderType.Sodexo, AcceptPaymentTenderType.PositiveTenderType.SwiggyOnline, AcceptPaymentTenderType.PositiveTenderType.Tr, AcceptPaymentTenderType.PositiveTenderType.ZomatoOnline, AcceptPaymentTenderType.PositiveTenderType.TicketRestaurant, AcceptPaymentTenderType.PositiveTenderType.OnlinePayment, AcceptPaymentTenderType.PositiveTenderType.Others  ', AcceptPaymentTenderType.NegativeTenderType.Cash ', AcceptPaymentTenderType.PositiveTenderType.ParkingCoupen
            Case AcceptPaymentTenderType.PositiveTenderType.Cash, AcceptPaymentTenderType.PositiveTenderType.Neft, AcceptPaymentTenderType.PositiveTenderType.Rtgs, _
                AcceptPaymentTenderType.PositiveTenderType.MealPass, AcceptPaymentTenderType.PositiveTenderType.Paytm, _
                AcceptPaymentTenderType.PositiveTenderType.QuickWallet, AcceptPaymentTenderType.PositiveTenderType.JioMoney, _
                AcceptPaymentTenderType.PositiveTenderType.Sodexo, AcceptPaymentTenderType.PositiveTenderType.SwiggyOnline, _
                AcceptPaymentTenderType.PositiveTenderType.Tr, AcceptPaymentTenderType.PositiveTenderType.ZomatoOnline, _
                AcceptPaymentTenderType.PositiveTenderType.TicketRestaurant, AcceptPaymentTenderType.PositiveTenderType.OnlinePayment, _
                ...
                AcceptPaymentTenderType.PositiveTenderType.Others, AcceptPaymentTenderType.PositiveTenderType.FoodPandaCash, _
                AcceptPaymentTenderType.PositiveTenderType.FoodPandaOnline  ', AcceptPaymentTenderType.NegativeTenderType.Cash ', AcceptPaymentTenderType.PositiveTenderType.ParkingCoupen
                ctrlPayCheque.Visible = False
                CtrlChequeDetails.Visible = False
    ...
    Private Sub btnapprove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnapprove.Click
        ...
        Select Case (SelectedReceiptTypeCode)
            ...
            Case AcceptPaymentTenderType.PositiveTenderType.QuickWallet
                InsertReceiptCashDetails()
            Case AcceptPaymentTenderType.PositiveTenderType.JioMoney
                InsertReceiptCashDetails()
            Case AcceptPaymentTenderType.PositiveTenderType.Sodexo
                InsertReceiptCashDetails()
            Case AcceptPaymentTenderType.PositiveTenderType.Tr
                InsertReceiptCashDetails()
            ...
            If Not cboRecieptType.SelectedValue Is Nothing Then
                ...
                If tenders.Count() > 0 AndAlso (tenders(0)("TenderType") = AcceptPaymentTenderType.PositiveTenderType.Credit Or tenders(0)("TenderType") = AcceptPaymentTenderType.PositiveTenderType.Cheque) Then
                    If Me._CardNo Is Nothing Then
                        ...
                        If (tenders(0)("TenderType").Equals(AcceptPaymentTenderType.PositiveTenderType.Credit.ToString())) And clsDefaultConfiguration.IsCustomerMandatoryForCreditSale = True Then
...
#End Region
    ...
    Private Sub remarksTextbox_Click(sender As Object, e As EventArgs) Handles remarksTextbox.Click
        If clsDefaultConfiguration.AllowOnScreenKeyBoard Then
            OnTouchKeyBoard()
        End If
    End Sub
    Private Sub remarksTextbox_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles remarksTextbox.KeyUp
        Try
    ...
    Private Sub remarksTextbox_TextChanged(sender As Object, e As System.EventArgs) Handles remarksTextbox.TextChanged
        Try
            Dim textEnd As String = remarksTextbox.Text.Substring(remarksTextbox.SelectionStart - 1, 1)
            ...
            If (_altWasPressed) Then
                ...
                Dim caretPos = remarksTextbox.SelectionStart
                If caretPos = 0 Then Exit Sub
                Dim text = remarksTextbox.Text
                ...
                If (caretPos <= text.Length) Then
                    ...
                    remarksTextbox.Text = textStart + textEnd
                    remarksTextbox.SelectionStart = caretPos - 1
    ...
    Private Sub rtxtSwipeCard_Click(sender As Object, e As EventArgs) Handles rtxtSwipeCard.Click
        If clsDefaultConfiguration.AllowOnScreenKeyBoard Then
            OnTouchKeyBoard()
        End If
    End Sub
