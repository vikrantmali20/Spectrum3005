...
''' <UpdatedOn></UpdatedOn>
''' <remarks></remarks>
Public Class frmDayCloseItemSearch
#Region "Global Variable's"
    Public SearchResult() As String
    Public ItemRow As DataRow
    Public ItemRows As New List(Of DataRow)
...
#Region "Class Events"
    Private Sub frmItemSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If dtItemScanData Is Nothing Then
                dtSearch = objItem.GetEANData(clsAdmin.SiteCode, "", clsAdmin.LangCode, condition, dtItemScanData, True)
            Else
                dtSearch = objItem.GetEANData(clsAdmin.SiteCode, "", clsAdmin.LangCode, condition, dtItemScanData, True)
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        End Try
    End Sub
    Private Function CheckIfAnyItemIsSelected() As Boolean
        Try
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
        Try
            If Not CheckIfAnyItemIsSelected() Then
                ShowMessage("Please check atleast one item", getValueByKey("CLAE04"))
                Exit Sub
            End If
            Dim i As Integer
...
#End Region
    ...
    Private Sub dgItemSearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgItemSearch.KeyDown
        Try
            ...
            ElseIf e.KeyCode = Keys.Space Then
                If dgItemSearch.Col > 0 Then
                    dgItemSearch.Item(dgItemSearch.Row)("Select") = Not dgItemSearch.Item(dgItemSearch.Row)("Select")
                    dgItemSearch.Columns("Select").RefetchCell()
                End If
    ...
    Private Function ThemeChange()
        ...
        dgItemSearch.Splits(0).Style.Font = New Font("Neo Sans", 10, FontStyle.Bold)
        ...
        cmdShow.FlatAppearance.BorderColor = Color.FromArgb(0, 81, 120)
        ...
        cmdAdvancedSearch.FlatAppearance.BorderColor = Color.FromArgb(0, 81, 120)
        ...
        Panel1.Size = New Size(240, 29)
        ' cmdOK.Location = New Point(3, 7)
        cmdCancel.Location = New Point(90, 3)
        cmdCancel.Size = New Size(130, 23)
        ...
        cmdCancel.Font = New Font("Neo Sans", 8.2, FontStyle.Bold)
        ...
        dgItemSearch.Styles(0).Font = New Font("Neo Sans", 10, FontStyle.Bold)
