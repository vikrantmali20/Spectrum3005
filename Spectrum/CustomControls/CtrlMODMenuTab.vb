...
Public Class CtrlMODMenuTab
    Private _NumberOfButtons As Decimal = 4
    Dim flpLabelWidth = (My.Computer.Screen.WorkingArea.Width * 720) / 1366
    Dim flpLabelHeight = (My.Computer.Screen.WorkingArea.Height * 677) / 1366
    Dim flpLabelHeightArticles = (My.Computer.Screen.WorkingArea.Height * 580) / 1366
    ...
    Private _Tabparent As frmTabCashMemo
    Public Property TabParent As frmTabCashMemo
        Get
            Return _Tabparent
        End Get
        Set(ByVal value As frmTabCashMemo)
            _Tabparent = value
        End Set
    End Property
    ...
    Public Sub AddArticleButton(ByVal articleCode As String, ByVal articleName As String, ByVal buttonId As String, ByVal groupId As String)
        ...
        AddHandler bt.Click, AddressOf TabParent.ModMenuCtrlBtn1_Click
    ...
    Public Sub AddSubTabsButton(ByVal articleCode As String, ByVal articleName As String, ByVal buttonId As String, ByVal groupId As String)
        ...
        bt.Margin = New Padding(0)
        bt.Padding = New Padding(0)
        AddHandler bt.Click, AddressOf TabParent.ModMenuSubCtrlBtn1_Click
        AddHandler bt.Leave, AddressOf TabParent.ModMenuCtrlBtn1_Leave
        'ShowArticleImageMOD(articleCode, bt)
    ...
    Public Sub AddSubArticles(ByVal articleCode As String, ByVal articleName As String, ByVal buttonId As String, ByVal groupId As String, ByRef flowPanel As FlowLayoutPanel)
        Dim lb As Label
        Dim pn As TableLayoutPanel
        Dim bt As CtrlBtn
        bt = New Spectrum.CtrlBtn()
    ...
    Public Sub AddSubArticlesTextMiddle(ByVal articleCode As String, ByVal articleName As String, ByVal buttonId As String, ByVal groupId As String, ByRef flowPanel As FlowLayoutPanel)
        Dim lb As Label
        Dim pn As TableLayoutPanel
        Dim bt As CtrlBtn
        bt = New Spectrum.CtrlBtn()
    ...
    Private Sub AddMultiTabs()
        ...
        AddHandler tabControlMain.Click, AddressOf TabParent.tabControlMain_Click
    End Sub
    Private Sub AddTabs()
        tabControlMain.Controls.Clear()
    ...
    Public Sub CreateButtonsInTabPanel()
        ...
        If clsDefaultConfiguration.ThemeSelect = "Theme 1" Then
            ...
            tabControlMain.BorderStyle = Windows.Forms.BorderStyle.None
            tabControlMain.MaximumSize = New Size((My.Computer.Screen.WorkingArea.Width * 745) / 1366, 544)
            tabControlMain.Size = New Size((My.Computer.Screen.WorkingArea.Width * 750) / 1366, 544)
        End If
        '  End If
    ...
    Public Sub CreateMultiButtonsInTabPanel()
        ...
        If clsDefaultConfiguration.ThemeSelect = "Theme 1" Then
            ...
            ' tabControlMain.Dock = DockStyle.Top
            tabControlMain.BorderStyle = Windows.Forms.BorderStyle.None
            tabControlMain.MaximumSize = New Size((My.Computer.Screen.WorkingArea.Width * 817) / 1366, 544)
            tabControlMain.Size = New Size((My.Computer.Screen.WorkingArea.Width * 817) / 1366, 544)
        End If
        Dim tabPage As C1DockingTabPage = (From page As C1DockingTabPage In tabControlMain.Controls Where page.Tag = ActiveTabId Select page).FirstOrDefault()
        If Not tabPage Is Nothing Then
            tabPage.Show()
    ...
    Public Sub CreateArticlesInTabPanelByGroup(ByVal dtImageInfos As DataTable, ByVal parentGroup As String, ByVal LastSelectedSubGroup As String)
        ...
        Else
            ...
            flowPanelx.MaximumSize = New System.Drawing.Size(flpLabelWidth, flpLabelHeight)
            flowPanelx.Size = New System.Drawing.Size(flpLabelWidth, flpLabelHeight)
        ...
        For Each drButton As DataRow In dvImageInfo.ToTable().Rows
            If clsDefaultConfiguration.DineInButtonWithText Then
                AddSubArticlesTextMiddle(drButton("ArticleCode"), drButton("ArticleName"), drButton("ID"), parentGroup, flowPanelx)
                flowPanelx.BorderStyle = Windows.Forms.BorderStyle.Fixed3D
                If clsDefaultConfiguration.ThemeSelect = "Theme 1" Then
                    flowPanelx.BackColor = Color.FromArgb(255, 255, 255)
                End If

            Else
                AddSubArticles(drButton("ArticleCode"), drButton("ArticleName"), drButton("ID"), parentGroup, flowPanelx)
            End If
        Next
FlowPanelFound:
        Dim tabPage As C1DockingTabPage = (From page As C1DockingTabPage In tabControlMain.Controls Where page.Tag = ActiveTabId Select page).FirstOrDefault()
