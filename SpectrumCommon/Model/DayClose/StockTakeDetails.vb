...
Public Class StockTakeDetails
    ...
    Public Property EnteredQty As Decimal?
        ...
        Set(ByVal value As Decimal?)
            ...
            If _EnteredQty IsNot Nothing Then
                ...
                Else
                    If HideControlsFromStockTake = True Then
                        If ArticleBaseUOM = "NOS" Then
                            If _EnteredQty = Int(_EnteredQty) Then
                                BUOMQty = _EnteredQty
                            Else
                                BUOMQty = 0
                                _EnteredQty = 0
                                Dim obj As New Information
                                obj.ArticleType = "NOS"
                                obj.ShowDialog()
                            End If
                        ElseIf ArticleBaseUOM = "KGS" Then
                            If _EnteredQty < 10 Then
                                BUOMQty = _EnteredQty
                            Else
                                BUOMQty = 0
                                _EnteredQty = 0
    ...
    Private _HideControlsFromStockTake As Boolean = False
